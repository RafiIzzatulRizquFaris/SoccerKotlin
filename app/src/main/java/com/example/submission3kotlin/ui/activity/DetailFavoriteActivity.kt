...
class DetailFavoriteActivity : AppCompatActivity(), DetailSearchContract.View {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        idawayteam = event.imgAway!!
        mPresenter.getDetailSearch(idevent)
        mPresenter.getDetailTeamAway(idawayteam)
        mPresenter.getDetailTeamHome(idhometeam)
